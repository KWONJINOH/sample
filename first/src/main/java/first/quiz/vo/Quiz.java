...
public class Quiz {
     ...
     */
    public void setQuizQuizId(String quizQuizId) {
     ...
     * 퀴즈를 초기화하는 사용자이다.
     *  
     * @param quizLevel 퀴즈 레벨
     * @param quizQuizId 퀴즈 식별자
     * @param quizProb 퀴즈 문제
     * @param quizDfty 퀴즈 난이도
     * @param quizProType 퀴즈 유형
     * @param quizEx 퀴즈보기
     * @param quizAw 퀴즈답
     */
    public Quiz(int quizLevel, String quizQuizId, String quizProb, String quizDfty, String quizProType, String quizEx, String quizAw) {
        super();
        this.quizLevel = quizLevel;
        this.quizQuizId = quizQuizId;
        this.quizProb = quizProb;
